...
<head>
  ...
  <title>เพิ่มเจ้าหน้าที่พนักงาน | สํานักงานพัฒนาสังคมและความมั่นคงของมนุษย์ นครราชสีมา</title>
...
<body>
  ...
  <div class="main-container d-flex">
    ...
    <div class="dashboard-content px-3 pt-4">
      <h2 class="fs-5"> เพิ่มข้อมูลเจ้าหน้าที่พนักงาน</h2>
      <hr>
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" id="role">
                      <option selected value="1">กรุณาเลือกสิทธิ์การเข้าถึงของเว็บไซต์</option>
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if(response === 'success') {
              Swal.fire({
                icon: 'success',
                title: 'บันทึกข้อมูลเจ้าหน้าที่พนักงานสำเร็จ',
                showConfirmButton: false,
                timer: 1500
              }).then((result) => {
              ...
              Swal.fire({
                icon: 'error',
                title: 'บันทึกข้อมูลเจ้าหน้าที่พนักงานไม่สำเร็จ โปรดลองอีกครั้ง',
              }).then((result) => {
                window.location = 'employees.php';
              })
            }
