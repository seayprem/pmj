...
<body>
  ...
  <div class="main-container d-flex">
    ...
    <div class="dashboard-content px-3 pt-4">
      ...
      <hr>
      <!-- START DATE SELECT  -->
      <form action="historyImport.php" method="POST">
      <div class="mb-3">
        <div class="row">
        ...
        <tbody>
          ...
          if(isset($_POST['time_select'])) {
            ...
            if(empty($date_start) && empty($time_start) && empty($date_end) && empty($time_end)) {
              ...
              $sql = "SELECT * FROM `transfer` WHERE transfer.emp_id = $emp_id AND DATE(t_datetime) BETWEEN '$date_start' AND '$date_end'";
            } else {
              $sql = "SELECT * FROM `transfer` WHERE transfer.emp_id = $emp_id AND t_datetime BETWEEN '$date_start $time_start' AND '$date_end $time_end'";
            }
