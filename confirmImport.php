...
<body>
  ...
  <div class="main-container d-flex">
    ...
    <form action="saveorderImport.php" method="POST">
    ...
    <?php
      ...
      foreach($_SESSION['cart'] as $id => $qty) {
        ...
        if($_REQUEST['act'] == "cancel") {
          ...
          echo '<script>window.location.href = "offices.php"</script>';
        }
    ...
    <div class="text-center">
      ...
      <a href="confirmImport.php?act=cancel" class="btn btn-danger">ยกเลิก</a>
    </div>
      </div>
      </form>
    <?php
